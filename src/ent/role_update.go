...
func (ru *RoleUpdate) AddUserIDs(ids ...xid.ID) *RoleUpdate {
...
func (ru *RoleUpdate) RemoveUserIDs(ids ...xid.ID) *RoleUpdate {
...
// AddUserIDs adds the "users" edge to the User entity by IDs.
func (ruo *RoleUpdateOne) AddUserIDs(ids ...xid.ID) *RoleUpdateOne {
...
// RemoveUserIDs removes the "users" edge to User entities by IDs.
func (ruo *RoleUpdateOne) RemoveUserIDs(ids ...xid.ID) *RoleUpdateOne {
