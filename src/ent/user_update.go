...
func (uu *UserUpdate) AddRoleIDs(ids ...xid.ID) *UserUpdate {
...
func (uu *UserUpdate) RemoveRoleIDs(ids ...xid.ID) *UserUpdate {
...
// AddRoleIDs adds the "roles" edge to the Role entity by IDs.
func (uuo *UserUpdateOne) AddRoleIDs(ids ...xid.ID) *UserUpdateOne {
...
// RemoveRoleIDs removes the "roles" edge to Role entities by IDs.
func (uuo *UserUpdateOne) RemoveRoleIDs(ids ...xid.ID) *UserUpdateOne {
