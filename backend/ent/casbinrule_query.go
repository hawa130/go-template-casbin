...
func (crq *CasbinRuleQuery) FirstIDX(ctx context.Context) xid.ID {
...
func (crq *CasbinRuleQuery) OnlyIDX(ctx context.Context) xid.ID {
...
func (crq *CasbinRuleQuery) IDs(ctx context.Context) (ids []xid.ID, err error) {
...
func (crq *CasbinRuleQuery) IDsX(ctx context.Context) []xid.ID {
	ids, err := crq.IDs(ctx)
	if err != nil {
		panic(err)
	}
